...
export const DEFAULT_INCOME_DESCRIPTIONS: Record<
  ...
  readonly string[]
> = {
  'ΣΥΝΔΡΟΜΕΣ ΑΘΛΗΤΩΝ': ['ΕΓΓΡΑΦΗ', 'ΣΥΝΔΡΟΜΗ ΜΗΝΑ', 'ΜΗΝΙΑΙΑ ΣΥΝΔΡΟΜΗ', 'ΕΤΗΣΙΑ ΣΥΝΔΡΟΜΗ'],
  'ΣΥΝΔΡΟΜΕΣ ΜΕΛΩΝ': ['ΣΥΝΔΡΟΜΗ ΜΗΝΑ', 'ΜΗΝΙΑΙΑ ΣΥΝΔΡΟΜΗ', 'ΕΤΗΣΙΑ ΣΥΝΔΡΟΜΗ', 'ΕΚΤΑΚΤΗ ΣΥΝΔΡΟΜΗ'],
  'ΕΙΣΙΤΗΡΙΑ ΑΓΩΝΩΝ': [
    'ΕΙΣΙΤΗΡΙΟ ΕΝΗΛΙΚΩΝ',
    'ΕΙΣΙΤΗΡΙΟ ΠΑΙΔΙΩΝ',
    'ΕΠΟΧΙΑΚΗ ΚΑΡΤΑ',
